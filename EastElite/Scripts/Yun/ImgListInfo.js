...
function showTime(YearS, Moth) {
    ...
    DFBGFlie.Flie.FlieOperation.AjaxList("../Details/GetImgListInfo", { time: time }, function (data) {
        if (data.ImgTitleInfoList != null) {
            for (var i = 0; i < data.ImgTitleInfoList.length; i++) {
                ...
                Html += "<span class=\"timeline-days-num\">" + data.ImgTitleInfoList[i].ShareFileID + " 张</span>";
                ...
                Html += " </div>";
                Html += "</div>";
                Html += "<div class=\"timeline-content global-clearfix list-content\">";
                for (var z = 0; z < data.ImgInfoList.length; z++) {
                    if (data.ImgInfoList[z].CreateUnitCode == data.ImgTitleInfoList[i].CreateUnitCode) {
